...
export LIBRARY_PATH=$(pwd)/whisper.cpp:$(pwd)/whisper.cpp/build/src:${HOME}/.ramble/lib
...
export C_INCLUDE_PATH=$(pwd)/whisper.cpp/include:${HOME}/.ramble/include
export CGO_CFLAGS="-I$(pwd)/whisper.cpp/include -I${HOME}/.ramble/include"
export CGO_LDFLAGS="-L$(pwd)/whisper.cpp -L$(pwd)/whisper.cpp/build -L$(pwd)/whisper.cpp/build/src -L${HOME}/.ramble/lib"
